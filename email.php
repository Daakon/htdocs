...
// change password
        ...
        if (strstr($url, "local")) {
            ...
            $link = "http://dev.rapportbook.com/create_pass?email=$email&id=$id";
        }
        else {
            $link = "http://www.rapportbook.com/create_pass?email=$email&id=$id";
        }
        $email = get_email_by_id($toId);
...
// photo comment
    ...
    if (strlen($notification) > 0) {
        ...
        $message .= "<td><img src = 'http://rapportbook.com/images/Playdoe-Logo.png' height='50' width='75' />&nbsp;&nbsp;<img src = 'http://rapportbook.com/images/Playdoe-red.png' height='50' width='75' /></td>";
