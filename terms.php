...
<h3>Rapportbook Terms:</h3>
    ...
    <p>
        <h5>Termination</h5>
            If you violate these terms, we reserve the right to stop providing access to Rapportbook.
    </p>

    <p>
        <h5>Disputes</h5>
    WE TRY TO KEEP RAPPORTBOOK UP, BUG-FREE, AND SAFE, BUT YOU USE IT AT YOUR OWN RISK. 
    WE ARE PROVIDING RAPPORTBOOK AS IS WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES INCLUDING, 
    BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, 
    AND NON-INFRINGEMENT. WE DO NOT GUARANTEE THAT RAPPORTBOOK WILL ALWAYS BE SAFE, 
    SECURE OR ERROR-FREE OR THAT RAPPORTBOOK WILL ALWAYS FUNCTION WITHOUT DISRUPTIONS, 
    DELAYS OR IMPERFECTIONS. RAPPORTBOOK IS NOT RESPONSIBLE FOR THE ACTIONS, CONTENT, INFORMATION, 
    ...
    OR INCIDENTAL DAMAGES ARISING OUT OF OR IN CONNECTION WITH THIS STATEMENT OR RAPPORTBOOK, 
    EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. 
    OUR AGGREGATE LIABILITY ARISING OUT OF THIS STATEMENT OR RAPPORTBOOK WILL NOT EXCEED 
