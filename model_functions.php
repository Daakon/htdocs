...
function dynamicPost($interest) {
    ...
    elseif ($interest == 'Design') {
        $dynamicText = 'you can appreciate beautiful engineering and design, whether graphic or architecture.';
    }

    elseif ($interest == 'Education') {
        $dynamicText = 'you are someone who cares about our education system and want to talk about it.';
    }

    elseif ($interest == 'Employment') {
        $dynamicText = 'you are looking for a job';
    }

    elseif ($interest == 'Fashion') {
        $dynamicText = 'you are into the latest and hottest fashion.';
    }

    elseif ($interest == 'Finance') {
        $dynamicText = 'you are into investing, credit or managing money.';
    }

    elseif ($interest == 'Fitness') {
        $dynamicText = 'you want to talk about the best workout routines and diets.';
    }
    ...
    elseif ($interest == 'Modeling') {
        $dynamicText = 'you are in the industry and want to share connections.';
    }

    elseif ($interest == 'Music') {
        $dynamicText = 'you are a musician or just want to talk about good music.';
    }

    elseif ($interest == 'Night Life') {
        $dynamicText = 'you are into going out and want talk about some of the hottest spots in the area.';
    }

    elseif ($interest == 'Photography') {
        $dynamicText = 'you love to take and share beautiful photos.';
    }

    elseif ($interest == 'Realty') {
        $dynamicText = 'you are into buying, selling, fixing up or inspecting properties.';
    }

    elseif ($interest == 'Sports') {
        $dynamicText = 'you are into playing or watching sports.';
    }

    elseif ($interest == 'Technology') {
        $dynamicText = 'you love new gadgets, software and hardware.';
    }

    elseif ($interest == 'Theatre') {
        $dynamicText = 'you have a love for the arts, as a fan or a performer.';
    }
    else {
        // fallback text
        $dynamicText = 'you want to chat';
    }
