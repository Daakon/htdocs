...
<div class="container">
    ...
    <div class="row row-padding" style="margin-top:-55px;">
        ...
        if (mysql_num_rows($result) > 0) {
            while ($rows = mysql_fetch_assoc($result)) {
                ...
                <div class="col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6 col-sm-12 col-xs-12 roll-call-feed" >
                    ...
                    echo '<table style="float:left;margin-top:10px">';
                    echo '<tr>';
                    echo '<td>';
                    ...
                    <div style="clear:both;margin-top:-20px;margin-bottom:10px;">
                        ...
                        if (mysql_num_rows($result3) > 0) {
                            echo '<div style="clear:both;margin-top:10px;"  class="comment-style">';
