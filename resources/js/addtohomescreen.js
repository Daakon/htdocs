...
ath.intl = {
	...
	en_us: {
		ios: 'To install this web app to your phone: tap %icon and then <strong>Add to Home Screen</strong>.',
		android: 'To install this web app to your phone open the browser option menu and tap on <strong>Add to homescreen</strong>. <small>The menu can be accessed by pressing the menu hardware button if your device has one, or by tapping the top right menu icon <span class="ath-action-icon">icon</span>.</small>',
	},
